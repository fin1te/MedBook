...
class SignUpViewModel : ViewModel() {
    ...
    fun validateAndRegister(name: String, password: String, confirmPassword: String, country: String) {
    ...
    fun initCountryDropdown(binding: FragmentSignUpBinding, context: Context) {
        val countryList = CountryRepository(context).getCountriesFromJson().map{it.value.country}.sorted()
